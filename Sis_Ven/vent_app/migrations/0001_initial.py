    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caracteristicas_categoria', models.CharField(choices=[('Comidas', 'Comidas'), ('Varios', 'Varios'), ('Bebidas', 'Bebidas'), ('Ropa', 'Ropa'), ('Limpieza', 'Limpieza')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vent_app.clientes')),
                ('empleado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vent_app.empleados')),
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vent_app.productos')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefono', models.CharField(max_length=10)),
                ('email', models.EmailField(max_length=254, unique=True)),
                ('empresa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vent_app.empresas')),
            ],
            options={
